          ...
          <View style={styles.modalContent}>
            ...
            <View style={styles.modalContentCentered}>
              <View style={styles.statusGrayWrapper2}>
                <Text
                  ...
                  onPress={() => Linking.openURL(`http://xplorer.powx.org/address/${this.state.contractToDisplay.release_address}`)}
                >
            ...
            <View style={styles.modalContentCentered}>
              <View style={styles.statusGrayWrapper2}>
                <Text
                  style={styles.statusGrayText2}
                  onPress={() => Linking.openURL(`http://explorer.powx.org/address/${this.state.contractToDisplay.escrow.address}`)}
                >
